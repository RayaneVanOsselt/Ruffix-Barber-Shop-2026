...
(function () {
  ...
  const TR = {
    ...
    fr: {
      ...
      "hero.pill1t": "Sur rendez-vous", "hero.pill1s": "Accueil privé, sans attente",
      "hero.pill2t": "Coupe · Barbe · Rasage", "hero.pill2s": "Techniques traditionnelles",
      "hero.pill3t": "Cadre premium", "hero.pill3s": "Barbier & coiffure homme",
      "about.badge": "Barbier premium", "services.cta": "Réserver un créneau",
      "faq.more": "Une autre question ?", "faq.contact": "Écrivez-nous",
      // À propos
      ...
      "resa.pt1": "Réservation en 3 étapes simples", "resa.pt2": "Confirmation par email du barbier",
      "resa.pt3": "Demande sans engagement",
      "contact.lead": "Une question, une demande particulière ? Écrivez-nous, nous répondons rapidement.",
      ...
      "insta.cardTitle": "Suivez le quotidien du salon",
      "insta.cardText": "Coupes du jour, coulisses et inspirations — retrouvez nos dernières réalisations et toute l'ambiance Rufix directement sur Instagram.",
      "insta.f1": "Coupes du jour", "insta.f2": "Coulisses du salon", "insta.f3": "Avant / après",
      // Avis
      "rev.eyebrow": "Avis clients", "rev.title": "Ils nous font confiance",
      "rev.lead": "L'avis de nos clients, en toute transparence.",
      "rev.badge": "Avis vérifiés Google", "rev.ctaTitle": "Votre avis compte",
      "rev.ctaText": "Vous avez apprécié votre passage chez Rufix Barber ? Partagez votre expérience sur Google — ça aide énormément le salon et les futurs clients.",
      "rev.leave": "Laisser un avis sur Google",
      "rev.verified": "Client vérifié", "rev.seeAll": "Voir tous les avis",
      "rev.allTitle": "Tous les avis", "rev.count": "avis", "rev.countP": "avis", "rev.avg": "note moyenne",
      "rev.leave2": "Laisser un avis", "rev.note": "Votre note", "rev.publish": "Publier mon avis",
      "rev.comPh": "Partagez votre expérience…", "rev.orGoogle": "Ou laissez un avis sur Google",
      "rev.first": "Soyez le premier à laisser un avis !",
      "rev.thanks": "Merci ! Votre avis a bien été reçu. Il sera vérifié puis publié.",
      "rev.errName": "Merci d'indiquer votre nom.", "rev.errNote": "Merci de choisir une note.",
      "rev.errCom": "Merci d'écrire un commentaire.", "rev.errGen": "Une erreur est survenue. Merci de réessayer.",
      ...
      // Footer
      "footer.tagline": "Barbier & salon de coiffure homme premium. Coupe, barbe et rasage sur rendez-vous.",
      "footer.ctaTitle": "Prêt à passer au fauteuil ?",
      "footer.ctaText": "Réservez votre créneau en quelques clics — confirmation par email du barbier.",
      "footer.ctaBtn": "Prendre rendez-vous",
    ...
    nl: {
      ...
      "hero.pill1t": "Op afspraak", "hero.pill1s": "Privé onthaal, geen wachttijd",
      "hero.pill2t": "Knippen · Baard · Scheren", "hero.pill2s": "Traditionele technieken",
      "hero.pill3t": "Premium kader", "hero.pill3s": "Herenkapper & barbier",
      "about.badge": "Premium barbier", "services.cta": "Een tijdslot reserveren",
      "faq.more": "Nog een vraag?", "faq.contact": "Schrijf ons",
      ...
      "resa.pt1": "Reserveren in 3 eenvoudige stappen", "resa.pt2": "Bevestiging per e-mail van de kapper",
      "resa.pt3": "Aanvraag zonder verplichting",
      "contact.lead": "Een vraag of bijzondere aanvraag? Schrijf ons, we antwoorden snel.",
      ...
      "insta.cardTitle": "Volg de dagelijkse gang van zaken",
      "insta.cardText": "Kapsels van de dag, achter de schermen en inspiratie — ontdek onze recentste realisaties en de Rufix-sfeer rechtstreeks op Instagram.",
      "insta.f1": "Kapsels van de dag", "insta.f2": "Achter de schermen", "insta.f3": "Voor / na",
      "rev.eyebrow": "Klantenreviews", "rev.title": "Zij vertrouwen ons",
      "rev.lead": "De mening van onze klanten, in alle transparantie.",
      "rev.badge": "Geverifieerde Google-reviews", "rev.ctaTitle": "Uw mening telt",
      "rev.ctaText": "Tevreden over uw bezoek bij Rufix Barber? Deel uw ervaring op Google — het helpt de zaak en toekomstige klanten enorm.",
      "rev.leave": "Laat een review achter op Google",
      "rev.verified": "Geverifieerde klant", "rev.seeAll": "Alle reviews bekijken",
      "rev.allTitle": "Alle reviews", "rev.count": "review", "rev.countP": "reviews", "rev.avg": "gemiddelde score",
      "rev.leave2": "Een review achterlaten", "rev.note": "Uw beoordeling", "rev.publish": "Mijn review plaatsen",
      "rev.comPh": "Deel uw ervaring…", "rev.orGoogle": "Of laat een review achter op Google",
      "rev.first": "Wees de eerste die een review achterlaat!",
      "rev.thanks": "Bedankt! Uw review is goed ontvangen. Hij wordt nagekeken en daarna gepubliceerd.",
      "rev.errName": "Vermeld uw naam a.u.b.", "rev.errNote": "Kies een beoordeling a.u.b.",
      "rev.errCom": "Schrijf een reactie a.u.b.", "rev.errGen": "Er is een fout opgetreden. Probeer opnieuw.",
      ...
      "footer.tagline": "Premium kapper & herenkapsel. Knippen, baard en scheren op afspraak.",
      "footer.ctaTitle": "Klaar voor de stoel?",
      "footer.ctaText": "Reserveer uw tijdslot in enkele klikken — bevestiging per e-mail van de kapper.",
      "footer.ctaBtn": "Een afspraak maken",
    ...
    en: {
      ...
      "hero.pill1t": "By appointment", "hero.pill1s": "Private welcome, no waiting",
      "hero.pill2t": "Cut · Beard · Shave", "hero.pill2s": "Traditional techniques",
      "hero.pill3t": "Premium setting", "hero.pill3s": "Men's barber & hair",
      "about.badge": "Premium barber", "services.cta": "Book a slot",
      "faq.more": "Another question?", "faq.contact": "Write to us",
      ...
      "resa.pt1": "Booking in 3 simple steps", "resa.pt2": "Confirmation by email from the barber",
      "resa.pt3": "Request with no commitment",
      "contact.lead": "A question or a special request? Write to us, we reply quickly.",
      ...
      "insta.cardTitle": "Follow the shop day to day",
      "insta.cardText": "Cuts of the day, behind the scenes and inspiration — see our latest work and the whole Rufix vibe straight on Instagram.",
      "insta.f1": "Cuts of the day", "insta.f2": "Behind the scenes", "insta.f3": "Before / after",
      "rev.eyebrow": "Client reviews", "rev.title": "They trust us",
      "rev.lead": "What our clients say, in full transparency.",
      "rev.badge": "Verified Google reviews", "rev.ctaTitle": "Your opinion matters",
      "rev.ctaText": "Enjoyed your visit at Rufix Barber? Share your experience on Google — it really helps the shop and future clients.",
      "rev.leave": "Leave a Google review",
      "rev.verified": "Verified client", "rev.seeAll": "See all reviews",
      "rev.allTitle": "All reviews", "rev.count": "review", "rev.countP": "reviews", "rev.avg": "average rating",
      "rev.leave2": "Leave a review", "rev.note": "Your rating", "rev.publish": "Post my review",
      "rev.comPh": "Share your experience…", "rev.orGoogle": "Or leave a Google review",
      "rev.first": "Be the first to leave a review!",
      "rev.thanks": "Thank you! Your review has been received. It will be checked and then published.",
      "rev.errName": "Please enter your name.", "rev.errNote": "Please choose a rating.",
      "rev.errCom": "Please write a comment.", "rev.errGen": "Something went wrong. Please try again.",
      ...
      "footer.tagline": "Premium barber & men's hair salon. Haircut, beard and shave by appointment.",
      "footer.ctaTitle": "Ready for the chair?",
      "footer.ctaText": "Book your slot in a few clicks — confirmation by email from the barber.",
      "footer.ctaBtn": "Book an appointment",
